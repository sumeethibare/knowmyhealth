    ...
    <div className="max-w-6xl mx-auto">
      <div className="flex flex-wrap items-center justify-center gap-4 py-10">
        {menuItems.map((item, index) => (
          ...
          >
            <a href={item.href} className="flex flex-col justify-center text-center items-center lg:hover:px-4 lg:hover:scale-125 hover:duration-300 duration-300 transition-all hover:skew-x-1">
